        ...
        <form action="" method="get">
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="profile-head">
                ...
                <p className="profile-rating mt-3 mb-5">
                  Ratings:<span className="ratings">1/5</span>{" "}
                </p>
                ...
                <ul class="nav" role="tablist">
                  ...
                  <li className="nav-item">
                  <a className="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile">
                      Timeline
                    </a>
                  </li>
                </ul>
            ...
            <div className="col-md-2">
                <button type="text" className="btn btn-primary profile-edit-btn" name="btn-addmore">Edit &nbsp;<i class="zmdi zmdi-edit"></i></button>
            </div>
          </div>
          <div className="row">
              <div className="col-md-4">
                <div className="profile-work">
                    <p>Work Links:</p>
                    <a href="https://google.com" target="_blank">Google Home</a><br />
                    <a href="https://google.com" target="_blank">Google Home</a><br />
                    <a href="https://google.com" target="_blank">Google Home</a><br />
                    <a href="https://google.com" target="_blank">Google Home</a><br />
                    <a href="https://google.com" target="_blank">Google Home</a><br />
